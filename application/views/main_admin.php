...
<div id="admin-panel">
	<ul>
		<li id="users-tab"><a href="#admin-users">Users</a></li>
		<li id="categories-tab"><a href="#admin-categories">Categories</a></li>
		<li id="topics-tab"><a href="#admin-topics">Topics</a></li>
	</ul>
	<div id="admin-users">
